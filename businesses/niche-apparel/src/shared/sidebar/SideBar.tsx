      ...
      <div className="at-offcanvas-area" aria-hidden={!open}>
        <div className={`at-offcanvas ${open ? "opened" : ""}`}>
          <div className="at-offcanvas-top d-flex align-items-center justify-content-between">
            <div className="at-offcanvas-logo">
              <Link to="/" className="text-decoration-none d-inline-flex align-items-center gap-2">
                <img data-width="30" src="/assets/imgs/template/logo/favicon.svg" alt="Aurelia" width={30} height={30} />
          ...
          <div className="at-offcanvas-content d-none d-xl-block">
            <h3 className="at-offcanvas-title">Welcome to Aurelia</h3>
            <p className="fz-font-lg">
              Considered, modern wardrobe essentials — designed to last and delivered to your door, with an AI stylist to help you choose.
            </p>
          </div>

          <div className="at-offcanvas-menu d-xl-none pb-50">
            <nav className="at-offcanvas-nav">
              <ul className="list-unstyled d-flex flex-column gap-3">
                <li><Link to="/" className="fz-24 fw-600">Home</Link></li>
                <li><Link to="/shop" className="fz-24 fw-600">Shop</Link></li>
                <li><Link to="/shop?c=woman" className="fz-24 fw-600">Women</Link></li>
                <li><Link to="/shop?c=man" className="fz-24 fw-600">Men</Link></li>
                <li><Link to="/about" className="fz-24 fw-600">About</Link></li>
                <li><Link to="/contact" className="fz-24 fw-600">Contact</Link></li>
              </ul>
            </nav>
          </div>
          ...
          <div className="at-offcanvas-contact">
            ...
            <ul>
              <li>
                <a className="fz-font-lg" href="tel:+15551234567">
                  +1 (555) 123-4567
                </a>
              </li>
              <li>
                <a className="fz-font-lg" href="mailto:hello@aurelia.com">
                  hello@aurelia.com
                </a>
              </li>
              <li>
