              ...
              <div className="d-flex flex-wrap align-items-start gap-5">
                <div className="at-header-logo">
                  <Link to="/" className="text-decoration-none d-inline-flex align-items-center gap-2">
                    <img data-width="30" src="/assets/imgs/template/logo/favicon-dark.svg" alt="Aurelia" width={30} height={30} />
                    <h6 className="fw-700 text-white mb-0 fz-24">Aurelia</h6>
                  </Link>
                </div>
                <div className="d-flex flex-column gap-3">
                  <h6 className="text-white mb-2 fw-medium">+1 (555) 123-4567</h6>
                  <h6 className="text-white mb-2">
                    <a href="mailto:hello@aurelia.com" className="text-white text-decoration-none">
                      hello@aurelia.com
                    </a>
                  </h6>
              ...
              <div className="at-footer-widget alt-footer-link-item-wrap row">
                <div className="alt-footer-link-item col-6">
                  <ul>
                    ...
                    <li className="mb-15"><Link to="/shop">Shop All</Link></li>
                    <li className="mb-15"><Link to="/shop?c=woman">Women</Link></li>
                    <li className="mb-15"><Link to="/shop?c=man">Men</Link></li>
                    <li className="mb-15"><Link to="/about">About</Link></li>
                  </ul>
                </div>
                <div className="alt-footer-link-item col-6">
                  <ul>
                    <li className="mb-15"><Link to="/shop?c=new">New In</Link></li>
                    <li className="mb-15"><Link to="/shop?c=sale">Sale</Link></li>
                    <li className="mb-15"><Link to="/contact">Contact</Link></li>
                    <li className="mb-15"><Link to="/contact">Shipping &amp; Returns</Link></li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-3 col-md-6 flex-column justify-content-lg-end d-none d-md-flex">
              ...
              <div className="at-footer-widget at-footer-link">
                <div className="at-hero-social">
                  <a href="#" onClick={(e) => e.preventDefault()}>Instagram {SOCIAL_ARROW}</a>
                  <a href="#" onClick={(e) => e.preventDefault()}>TikTok {SOCIAL_ARROW}</a>
                  <a href="#" onClick={(e) => e.preventDefault()}>Pinterest {SOCIAL_ARROW}</a>
                  <a href="#" onClick={(e) => e.preventDefault()}>Facebook {SOCIAL_ARROW}</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="footer-2-border pt-40 pb-40">
            <div className="row align-items-end g-4">
              <div className="col-lg-10 col-md-8">
                <span className="at-footer-copyright">Aurelia © 2026 · Powered by Phoxta</span>
                <div className="at-title-anim overflow-hidden">
                  <h2 className="footer-2-connect-title text-white mb-0 at-title-text text-scale-anim">Stay in Style</h2>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 text-end">
                <div className="d-flex flex-wrap align-items-end gap-4 gap-md-5 mb-3">
                  <div className="footer-2-hours text-white">
                    <span className="d-block fz-font-md opacity-50">Customer Care</span>
                    <h5 className="fw-400 common-white">Mon - Sat</h5>
                  </div>
                </div>
              </div>
            </div>
