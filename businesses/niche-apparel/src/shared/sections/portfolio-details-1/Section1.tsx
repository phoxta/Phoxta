...
const SLIDER_IMAGES = [
    { src: "/assets/imgs/pages/img-177.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-176.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-178.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-179.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-180.webp", alt: "phoxta" },
];
                        ...
                        <div className="testimonial-author d-flex align-items-start mb-0 gap-4 pt-60 w-75">
                            ...
                            <div className="testimonial-content">
                                <p className="fz-3xl neutral-900 fw-400">
                                    &quot;Phoxta completely transformed how we present our brand online. Their strategic
