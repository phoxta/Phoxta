...
const TESTIMONIAL_SOURCES = [
    {
        ...
        logoHeight: 25,
        name: "Maya Whitfield",
        position: "Audience Founder",
        company: "London, United Kingdom",
        comment:
            "I launched my wellness brand in six weeks, not six months. The AI answers most of my customers, so I get to focus on the part I love.",
    },
    {
        starColor: "#585959",
        ...
        logoHeight: 25,
        name: "Tom Reyes",
        position: "Acquisition Entrepreneur",
        company: "Austin, USA",
        comment:
            "I could see the numbers before I committed. No legacy mess to untangle — I now run a portfolio of businesses from one dashboard.",
    },
    {
        starColor: "#FFB618",
        ...
        comment:
            "It replaced four tools I was paying for, and the AI receptionist books appointments while I sleep. Setup paid for itself in weeks.",
    },
];
