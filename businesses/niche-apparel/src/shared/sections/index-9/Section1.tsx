...
const brandLogos = [
    { src: "/assets/imgs/pages/home-9/logo-brand-01.webp", alt: "phoxta", delay: ".1" },
    { src: "/assets/imgs/pages/home-9/logo-brand-02.webp", alt: "phoxta", delay: ".2" },
    { src: "/assets/imgs/pages/home-9/logo-brand-03.webp", alt: "phoxta", delay: ".3" },
    { src: "/assets/imgs/pages/home-9/logo-brand-04.webp", alt: "phoxta", delay: ".4" },
    { src: "/assets/imgs/pages/home-9/logo-brand-06.webp", alt: "phoxta", delay: ".5" },
    { src: "/assets/imgs/pages/home-9/logo-brand-07.webp", alt: "phoxta", delay: ".6" },
];
                    ...
                    <div className="sec-1-home-9__row sec-1-home-9__row--top">
                        ...
                        <div className="sec-1-home-9__intro at_fade_anim" data-delay=".2" data-fade-from="bottom">
                            ...
                            <p className="sec-1-home-9__intro-text reveal-text text-white">
                                <RevealText>
                                    Based in Canada, <span className="text-theme text-scramble">Phoxta</span> is a creative design agency dedicated to providing innovative brand solutions for a global clientele.
                                </RevealText>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="sec-1-home-9__row sec-1-home-9__row--middle">
                        ...
                        <div className="sec-1-home-9__thumbs mt-md-0 mt-4">
                            {thumbnails.map((thumb, i) => (
                                ...
                                >
                                    <img src={thumb.src} alt="phoxta" width={300} height={400} loading="lazy" />
                                </div>
                            ))}
                        </div>
                    </div>
