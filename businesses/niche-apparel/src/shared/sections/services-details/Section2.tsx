...
const SLIDES = [
    { src: "/assets/imgs/pages/img-156.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-157.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-158.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-159.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-160.webp", alt: "phoxta" },
];
