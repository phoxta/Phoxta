          ...
          <div className="row align-items-center">
            <div className="col-xl-2 col-6">
              <div className="at-header-logo">
                <Link to="/" className="text-decoration-none d-inline-flex align-items-center gap-2">
                  <img width={30} height={30} src="/assets/imgs/template/logo/favicon.svg" alt="Aurelia" />
            ...
            <div className="col-xl-2 col-6">
              <div className="at-header-right gap-3 d-flex justify-content-end align-items-center">
                ...
                <button type="button" className="at-header-search-btn p-relative" aria-label="Bag" onClick={() => setOpen(true)}>
                  ...
                  {count > 0 && (
                    <span className="p-absolute bg-dark text-white rounded-circle d-flex align-items-center justify-content-center" style={{ top: -6, right: -8, width: 16, height: 16, fontSize: 10 }}>{count}</span>
                  )}
                </button>
