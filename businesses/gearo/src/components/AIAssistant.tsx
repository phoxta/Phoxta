...
const LABEL = "Ask us";
const TITLE = "Product assistant";
const SUBTITLE = "AI assistant · products, stock & delivery";
const GREETING = "Hi — I can help you find the right piece, check stock and track an order. What are you after?";
const FALLBACK = "I can help with products, stock and delivery. What are you looking for?";
...
export default function AIAssistant() {
  ...
  useEffect(() => {
    ...
    const tick = async () => {
      ...
      if (key && conv.current && Date.now() - lastActivity.current <= POLL_IDLE_MS) {
        try {
          await pollOnce(key);
          failures = 0;
        } catch {
