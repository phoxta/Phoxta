...
/**
 * Link columns and social icons shared by Footer2, Footer3 and Footer4.
 *
 * Footer3 and Footer4 render byte-identical data; Footer2 differs in one place
 * only — "Insights" sits in Legal rather than Solutions — so the two variants
 * are separate exports rather than a transform, to keep each rendered list
 * exactly as it was.
 */
...
const svg = (props: SVGProps<SVGSVGElement>, ...children: ReactElement[]) =>
    h("svg", { fill: "currentColor", viewBox: "0 0 24 24", ...props }, ...children);

const EVENODD = { fillRule: "evenodd" as const, clipRule: "evenodd" as const };
...
/** Footer3 and Footer4: "Insights" is the fifth Solutions link. */
...
/** Footer2: the same links, but "Insights" is the fourth Legal link. */
export const FOOTER_NAV_ALT: FooterNav = {
    solutions: [
        { name: "Marketing", href: "#" },
        { name: "Analytics", href: "#" },
        { name: "Automation", href: "#" },
