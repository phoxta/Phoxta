import bgGradientImage from '@/assets/images/gradient-bg-1.png'
import Img from '@/components/media/img'
import GoogleLogoSvg from '@/components/primitives/google-logo-svg'
            ...
            <TabPanels>
              {testimonials.map((testimonial, index) => (
                <TabPanel key={index} unmount={false} className="flex max-w-md flex-col focus:outline-none">
                  ...
                  {/* Quotes carry inline <br /> markup, hence the raw-HTML render. */}
                  <Text
