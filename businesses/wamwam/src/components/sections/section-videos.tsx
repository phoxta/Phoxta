...
const demo_videos: VideoType[] = [
  {
    ...
    thumbnail:
      '/images/catalog/131423-1260.webp',
  },
  {
    id: 'y7gKlzvg8xk',
    title: 'Magical Scotland - 4K Scenic Relaxation Film with Calming Music',
    thumbnail:
      '/images/catalog/186077-1260.webp',
  },
  {
    id: 'fKXaypnVL8s',
    title: 'Magical Scotland - 4K Scenic Relaxation Film with Calming Music',
    thumbnail:
      '/images/catalog/1660995-1260.webp',
  },
  {
    id: 'unPKJJjQP0A',
    title: 'Magical Scotland - 4K Scenic Relaxation Film with Calming Music',
    thumbnail:
      '/images/catalog/4983184-1260.webp',
  },
  {
    id: 'vazwd0HOohE',
    title: 'Magical Scotland - 4K Scenic Relaxation Film with Calming Music',
    thumbnail:
      '/images/catalog/2549018-1260.webp',
  },
]
...
export default function SectionVideos({ videos = demo_videos, className = '' }: SectionVideosProps) {
    ...
    return (
      <div
        ...
        onClick={() => {
          ...
          // Picking a thumbnail starts playback straight away rather than showing another poster.
