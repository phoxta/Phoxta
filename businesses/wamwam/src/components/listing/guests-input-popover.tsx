...
interface GuestsInputPopoverProps {
    className?: string;
}

export default function GuestsInputPopover({ className = "flex-1" }: GuestsInputPopoverProps) {
                ...
                <>
                    ...
                    >
                        <NcInputNumber
                            ...
                            onChange={setGuestAdultsInputValue}
                        ...
                        <NcInputNumber
                            ...
                            onChange={setGuestChildrenInputValue}
                        ...
                        <NcInputNumber
                            ...
                            onChange={setGuestInfantsInputValue}
