...
import type { ListingReview as Review } from "@/types/content";

interface SectionListingReviewsProps {
    reviewCount: number;
    reviewStart: number;
    reviews: Review[];
}

export default function SectionListingReviews({ reviews, reviewCount, reviewStart }: SectionListingReviewsProps) {
            ...
            <div className="flex flex-col gap-y-6 sm:gap-y-8">
                ...
                <div className="relative">
                    ...
                    <div className="absolute end-2 top-1/2 -translate-y-1/2">
                        <ButtonCircle className="size-12!" aria-label="Submit review">
