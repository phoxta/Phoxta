...
/**
 * The shadcn-style variant button from the source template.
 *
 * Distinct from `primitives/button.tsx` (the design system's own Button, which
 * is what the app actually renders); this one is kept for parity and is named
 * `ui-button` so the two never collide on import.
 */
...
function UiButton({ className, variant = "default", size = "default", asChild = false, ...props }: UiButtonProps) {
