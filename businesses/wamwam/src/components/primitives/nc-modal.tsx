...
export interface NcModalProps {
    ...
    /** Receives an opener; render your own trigger with it. */
    renderTrigger?: (openModal: () => void) => ReactNode;
    contentExtraClass?: string;
    contentPaddingClass?: string;
    triggerText?: ReactNode;
    modalTitle?: ReactNode;
    /** Pass a boolean to control the modal; omit to let it manage its own state. */
    isOpenProp?: boolean;
    onCloseModal?: () => void;
}

export default function NcModal({
    renderTrigger,
    renderContent,
            ...
            <Transition appear show={isOpen} as={Fragment}>
                <Dialog as="div" className="fixed inset-0 z-50 overflow-y-auto" onClose={closeModal}>
                    <div className="min-h-screen px-1 text-center md:px-4">
                        ...
                        {/* Tricks the browser into vertically centring the panel. */}
