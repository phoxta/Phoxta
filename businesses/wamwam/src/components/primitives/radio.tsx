...
// `base` and `colors` are kept verbatim from the design system's radio.tsx
// (its formatting included) so the class tables diff cleanly against upstream.
const base = [
  // Basic layout
...
export function Radio({
    ...
    className,
    ...props
}: { color?: Color; className?: string; ref?: Ref<HTMLElement> } & Omit<Headless.RadioProps, "as" | "className" | "children">) {
    return (
        <Headless.Radio
            data-slot="control"
            {...props}
