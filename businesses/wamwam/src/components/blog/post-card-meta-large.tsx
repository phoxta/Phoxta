...
/**
 * Byline variant taking a flat author shape and an optional larger size.
 * Distinct from `post-card-meta`, which takes a BlogPost's nested author and
 * links to /blog; this one renders no link and can size up its avatar.
 */
export default function PostCardMetaLarge({
