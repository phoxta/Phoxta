...
/** Rendered when a caller passes no author — a stand-in with an empty avatar. */
...
export default function CardAuthorBox2({ className = "", author = DEMO_AUTHOR }: CardAuthorBox2Props) {
        ...
        >
            <div className="relative shrink-0">
                <div className="aspect-w-7 flex h-0 w-full aspect-h-3 md:aspect-h-4">
                    <Img fill alt="" src={bgImage || ""} sizes="(max-width: 400px) 100vw, 400px" />
                </div>
            ...
            <div className="relative flex -translate-y-7 flex-col items-center px-6 pt-[1px] text-center">
                {/* The scalloped notch the avatar sits in; fill follows the card background. */}
                <svg
