...
/**
 * Header for a two-month calendar: the left month shows only "previous", the
 * right month only "next" (the other arrow is kept in flow but hidden so both
 * headers keep the same width).
 */
