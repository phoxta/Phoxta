...
export default function AddListingStep8() {
        ...
        <>
            <div>
                ...
                <span className="mt-2 block text-muted-foreground">
                    The host&lsquo;s revenue is directly dependent on the setting of rates and regulations on the number
                    of guests, the number of nights, and the cancellation policy.
                </span>
            </div>

            <Divider />
            {/* FORM */}
            <QueryForm id="add-listing-form" action={handleSubmitForm} className="space-y-8">
                {/* ITEM */}
