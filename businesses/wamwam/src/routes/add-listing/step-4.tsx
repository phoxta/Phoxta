...
import { Fieldset, Label } from "@/components/primitives/fieldset";
...
const generalAmenities: AmenityOption[] = [
    {
        label: "Wifi",
        name: "Wifi",
        defaultChecked: true,
...
const otherAmenities: AmenityOption[] = [
    {
        label: "Wardrobe",
        name: "Wardrobe",
        defaultChecked: true,
...
const safeAmenities: AmenityOption[] = [
    {
        label: "Fire siren",
        name: "Fire siren",
        defaultChecked: true,
...
export default function AddListingStep4() {
    ...
    return (
        <>
            ...
            {/* FORM */}
            <QueryForm id="add-listing-form" action={handleSubmitForm} className="flex flex-col gap-y-12">
                <div>
