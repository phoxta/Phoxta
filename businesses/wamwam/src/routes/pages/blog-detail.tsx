...
import { BadgeButton } from '@/components/primitives/badge'
...
import { getBlogPosts, getBlogPostByHandle } from '@/data/content'

export default function BlogDetailPage({ params }: RouteProps) {
  const { featuredImage, author, date, title, timeToRead, category, tags } = getBlogPostByHandle(params.handle ?? '')
  ...
  // The body is the design system's typography specimen, not the post's own
  // prose — it is what this template has always rendered here.
  const renderContent = () => {
    return (
      <div
      ...
      >
        ...
        <figure>
          <Img
            src="/images/catalog/6802060-1260.webp"
            alt="nc blog"
