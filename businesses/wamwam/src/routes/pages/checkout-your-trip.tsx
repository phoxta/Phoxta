...
import ModalSelectDate from '@/components/cards/modal-select-date'
import ModalSelectGuests from '@/components/cards/modal-select-guests'
...
export default function YourTrip() {
  // Seeded relative to today (the original literals were fixed 2025 dates and
  // had gone stale); the 17-day span between them is preserved.
            ...
            >
              <div className="flex flex-col">
                ...
                <span className="mt-1.5 text-lg font-medium">
                  {startDate ? formatDateRange([startDate, endDate]) : 'Add dates'}
                </span>
              </div>
