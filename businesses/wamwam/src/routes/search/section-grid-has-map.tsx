...
import MapWithMarkers from "@/routes/search/map-with-markers";
...
export default function SectionGridHasMap({ listings, filterOptions }: SectionGridHasMapProps) {
    const [currentHoverID, setCurrentHoverID] = useState<string>("");
    const [showMap, setShowMap] = useState(false);

    return (
        <div className="relative flex min-h-screen gap-8 2xl:gap-12">
            ...
            <div className={clsx("flex-1 lg:flex-1/2", showMap ? "block" : "hidden lg:block")}>
                <div className="fixed inset-0 top-0 flex lg:sticky lg:top-22.5 lg:size-full lg:max-h-[calc(100vh-calc(var(--spacing)*22))] lg:py-6">
