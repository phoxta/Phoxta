...
/**
 * Design-system forgot-password template — ported, unrouted and unwired.
 *
 * /forgot-password renders routes/account/account.tsx, whose "Forgot password"
 * control sends the real reset email. This form posts nowhere.
 */
