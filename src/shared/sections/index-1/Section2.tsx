                        ...
                        <div className="at-about-title-wrap mb-30">
                            <span className="at-btn common-black bg-transparent mb-10 rounded-0 p-0">
                                <span className="text-uppercase">
                                    <span className="text-1">What is Phoxta</span>
                                    <span className="text-2">What is Phoxta</span>
                                </span>
                                <i>{ARROW_SVG}{ARROW_SVG}</i>
                            </span>
                            <h3 className="at-section-title mb-0">
                                <span className="">
                                    Skip the year of building. Get a complete, AI-powered business that&apos;s ready to run on day one &mdash; and make it your own.
                                </span>
                                <span className="at-about-btn-transform ml-20">
                                    <Link className="at-btn" to="/about-2">
                                        <span>
                        ...
                        <div className="col-xxl-2 col-lg-3 col-md-7 mb-md-5">
                            <div className="at-about-subtitle-wrap mb-30">
                                <span className="at-about-subtitle">
                                    ...
                                    <span className="fw-700">Real</span> businesses, not templates &mdash; with the AI <br />
                                    and automations already running.
                                </span>
                            </div>
                                    ...
                                    <div className="col-lg-6 col-md-6">
                                        <div className="at-about-item anim-zoomin-wrap mb-40">
                                            ...
                                            <div className="at-about-content">
                                                <h3 className="at-about-title mb-10 at-char-animation">A working business, day one</h3>
                                                <p className="at-about-dec at_fade_anim">
                                                    No six-month build, no agency invoice. You inherit a live storefront, real products and content, payments wired up, and operations already running &mdash; ready to make your own.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
