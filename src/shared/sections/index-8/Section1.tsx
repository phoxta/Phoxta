...
export default function Section1() {
    return (
        <section className="sec-1-home-8 p-relative overflow-hidden">
                    ...
                    <div className="col-xl-6 h8-col-right">
                        <div className="h8-photos d-flex align-items-start">
                            <div className="h8-photo-box anim-zoomin-wrap" scroll-parallax-range="228" data-h8-parallax-ease="sine.inOut">
                                <img className="anim-zoomin" src="/assets/imgs/pages/home-8/hero8-img-1.webp" alt="phoxta" width={500} height={600} loading="lazy" />
                            </div>
                            <div className="h8-photo-box h8-photo-down anim-zoomin-wrap" scroll-parallax-range="110" data-h8-parallax-ease="power3.in">
                                <img className="anim-zoomin" src="/assets/imgs/pages/home-8/hero8-img-2.webp" alt="phoxta" width={500} height={600} loading="lazy" />
                            </div>
                            <div className="h8-photo-box anim-zoomin-wrap" scroll-parallax-range="52" data-h8-parallax-ease="sine.inOut">
                                <img className="anim-zoomin" src="/assets/imgs/pages/home-8/hero8-img-3.webp" alt="phoxta" width={500} height={600} loading="lazy" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="col-xl-6 h8-col-left-2 d-none d-xl-block">
                        <div className="h8-photos d-flex align-items-start">
                            <div className="h8-photo-box h8-photo-down anim-zoomin-wrap" scroll-parallax-range="92" data-h8-parallax-ease="expo.in">
                                <img className="anim-zoomin" src="/assets/imgs/pages/home-8/hero8-img-4.webp" alt="phoxta" width={500} height={600} loading="lazy" />
                            </div>
                            <div className="h8-photo-box anim-zoomin-wrap" scroll-parallax-range="24" data-h8-parallax-ease="none">
                                <img className="anim-zoomin" src="/assets/imgs/pages/home-8/hero8-img-5.webp" alt="phoxta" width={500} height={600} loading="lazy" />
                            </div>
                            <div className="h8-photo-box h8-photo-down anim-zoomin-wrap" scroll-parallax-range="125" data-h8-parallax-ease="power2.inOut">
                                <img className="anim-zoomin" src="/assets/imgs/pages/home-8/hero8-img-6.webp" alt="phoxta" width={500} height={600} loading="lazy" />
                            </div>
                        </div>
                    </div>
            ...
            {/* ============================================================
                 BOTTOM BAND: Oversized "PHOXTA® / STUDIO" type with portrait
            ============================================================ */}
            <div className="h8-bottom-band">
                <p className="h8-big-title">
                    <span className="h8-word text-scale-anim">PHOXTA</span><sup className="h8-registered">&#174;</sup>
                    <span className="h8-portrait-frame">
                        <img src="/assets/imgs/pages/home-8/hero8-img-8.gif" alt="phoxta" width={120} height={120} loading="lazy" />
                    </span>
                ...
                <div className="h8-bottom-meta d-flex align-items-center justify-content-between">
                    <span className="h8-meta-text text-scramble" data-scramble-text="hello@phoxta.com">hello@phoxta.com</span>
