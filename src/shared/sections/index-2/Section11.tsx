...
const MARQUEE_ROWS: MarqueeRow[] = [
    ...
    { dir: "right", items: ["SCROLL TO REVEAL", "•", "PHOXTA", "•", "BEHIND THE SCENES", "•", "2026", "•"] },
    { dir: "left", items: ["PLAY", "•", "SHOWREEL", "•", "PHOXTA STUDIO", "•", "WATCH", "•"] },
                ...
                <div className="postbox-item-wrap">
                    <div className="postbox-item">
                        <div className="postbox-thumb p-relative rounded-5">
                            ...
                            <a href="#">
                                <img className="postbox-scroll-zoom-img img-cover" src="/assets/imgs/pages/bg-img-2.webp" alt="Phoxta" loading="lazy" />
                            </a>
