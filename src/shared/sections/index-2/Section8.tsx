...
const SLIDES = [
    { src: "/assets/imgs/pages/img-48.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-45.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-46.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-47.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-49.webp", alt: "phoxta" },
];
