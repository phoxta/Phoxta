...
const FAQ_ITEMS = [
    ...
    },
    {
        ...
        answer: "Every plan includes your AI agent across all channels, the full operating console, your hosted storefront, and a monthly AI usage allowance that scales with the plan (200K, 1M or 5M tokens).",
        open: false,
    },
    {
        id: "collapseThree",
        num: "3",
        question: "What's the one-time business price?",
        answer: "Each business blueprint in the Marketplace has a one-time price shown on its listing. You own that business outright — the monthly subscription covers running it on Phoxta.",
        open: false,
    },
    {
        id: "collapseFour",
        ...
        answer: "Yes — upgrade or downgrade anytime as you grow, and cancel whenever you like. If you cancel, your data stays with you and your storefront simply pauses until you reactivate.",
        open: false,
    },
];
