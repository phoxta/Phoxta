        ...
        <section className="sec-1-home-14" aria-label="Photography hero">
            <div className="sec-1-home-14__inner">
                ...
                <figure className="sec-1-home-14__hero anim-zoomin-wrap">
                    <img className="sec-1-home-14__hero-img anim-zoomin" data-speed=".8" src="/assets/imgs/pages/home-14/sec-1-hero.webp" alt="Phoxta" loading="lazy" />
                    <div className="sec-1-home-14__hero-overlay">
                        <div className="sec-1-home-14__hero-top">
                            ...
                            <p className="sec-1-home-14__hero-credit mb-0 text-white">Photograph by Studio Phoxta &middot; &middot; 2025</p>
                        </div>
