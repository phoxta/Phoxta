...
// Home v2 — the marketplace showcase. Same studio PortfolioCard1 UI as the live
// homepage (index-1/Section5), but every card links to the PUBLIC marketplace
// (/marketplace) instead of the protected /dashboard/marketplace/:slug, fixing
// the funnel leak where public visitors were bounced to the login wall.
...
const PORTFOLIO_ITEMS = [
    {
        ...
        tags: [
            { label: "Automotive", href: "/marketplace" },
            { label: "From $3,900", href: "/marketplace" },
            { label: "AI inside", href: "/marketplace" },
        ],
    },
    {
        classList: "mb-55",
        ...
        tags: [
            { label: "eCommerce", href: "/marketplace" },
            { label: "From $1,500", href: "/marketplace" },
            { label: "AI inside", href: "/marketplace" },
        ],
    },
    {
        ...
        tags: [
            { label: "Hospitality", href: "/marketplace" },
            { label: "From $1,500", href: "/marketplace" },
            { label: "AI inside", href: "/marketplace" },
        ],
    },
    {
        ...
        description: "A travel booking site for stays and experiences, with an AI trip planner",
        tags: [
            { label: "Travel", href: "/marketplace" },
            { label: "From $3,600", href: "/marketplace" },
            { label: "AI inside", href: "/marketplace" },
        ],
    },
    {
        ...
        tags: [
            { label: "eCommerce", href: "/marketplace" },
            { label: "From $1,400", href: "/marketplace" },
            { label: "AI inside", href: "/marketplace" },
        ],
    },
];

export default function Marketplace({ classList = "" }: { classList?: string }) {
    return (
                    ...
                    <div className="col-xxl-4 col-lg-4">
                        <div className="mg-portfolio-title-wrap mg-portfolio-pin mb-30">
                            ...
                            <h2 className="alt-section-title lh-1 mb-30 reveal-text">
                                <RevealText>Businesses ready to make your own</RevealText>
                            </h2>
                            <div className="at_fade_anim" data-delay=".3">
                                <p className="mg-portfolio-dec mb-50">
                                    A handpicked selection of live, AI-powered businesses with a proven track record &mdash; each
                                    one ready to brand, launch and run as your own in minutes.
                                </p>
                            </div>
