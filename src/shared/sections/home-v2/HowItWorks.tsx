...
// Home v2 — "How it works" (3 + 1 step funnel). Reuses the studio process-card
// UI from index-4/Section3 (card__process-card + background grid) with Phoxta
// content: Pick → Make it yours → Launch → Run & grow.
...
const PROCESS_CARDS = [
    {
        ...
        description: "Choose a validated, AI-powered business with a proven track record — and preview it live before you commit.",
    },
    {
        cardClass: "card-2",
        ...
        num: "02",
        title: "Make it yours",
        description: "Your brand, your domain, your payment account. A fully independent business that belongs to you — no lock-in.",
    },
    {
        cardClass: "card-3",
        ...
        description: "Go live with a fast storefront and mobile app, then follow a guided 30-day onboarding to your first sale.",
    },
    {
        cardClass: "card-4",
        ...
        num: "04",
        title: "Run & grow",
        description: "One AI agent handles sales and support on every channel, 24/7 — while you scale to more businesses from a single login.",
    },
];
...
export default function HowItWorks() {
    return (
        <div id="how-it-works" className="container-2200 bg-neutral-50">
                ...
                <div className="container p-relative z-1">
                    <div className="row align-items-end g-4">
                        <div className="col-lg-6 col-md-10">
                            ...
                            <h3 className="reveal-text mb-0">
                                <RevealText>From the marketplace to your own business in four steps</RevealText>
                            </h3>
                        </div>
                    ...
                    <div className="row align-items-center g-md-5 g-4 mt-lg-0 mt-20">
                        <div className="col-lg-3 order-lg-1 order-2">
                            <div className="at_fade_anim" data-delay=".4" data-fade-from="bottom" data-ease="bounce">
                                <img
                        ...
                        <div className="col-lg-4 order-lg-2 order-1">
                            ...
                            <span className="fz-font-3xl neutral-900 reveal-text">
                                <RevealText>
                                    Skip the year of building. Inherit a business that already works — and make it your own.
                                </RevealText>
                            </span>
                        </div>
                    </div>
