...
// Home v2 — closing CTA. Reuses the studio contact-CTA UI from index-9/Section10
// (bg-neutral-900 + moving gallery), which is fully responsive — fixing the live
// homepage's final banner that was hidden on mobile (d-none d-lg-block).
                ...
                <div className="container position-relative z-2 text-center">
                    <div className="content-wrapper d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div className="at-btn-group btn-brand-1 at_fade_anim" data-delay=".4" data-fade-from="bottom" data-ease="bounce">
                            ...
                            <Link className="at-btn z-index-1" to="/marketplace">Browse the marketplace</Link>
                            <Link className="at-btn-circle" to="/marketplace">
                                <LongArrowRight />
                            </Link>
                        </div>
                        <Link className="at-btn common-white text-uppercase bg-transparent rounded-0 p-0 pb-2 mt-30" style={{ borderBottom: "1px solid rgba(255,255,255,.55)" }} to="/auth?mode=signup">
                            <span className="text-uppercase">
                                <span className="text-1">Or create your account</span>
                                <span className="text-2">Or create your account</span>
                            </span>
                            <i>
                                <ArrowIcon />
                            </i>
                    ...
                    <div className="moving-gallery at_fade_anim carouselTicker carouselTicker-left" data-delay=".5" data-fade-from="bottom" data-ease="bounce">
                        <ul className="wrapper-gallery carouselTicker__list scroll-move-left">
                            {galleryImages.map((img, i) => (
                                <li key={i}>
                                    <img src={img} alt="phoxta" width={300} height={200} loading="lazy" />
                                </li>
                            ))}
                        </ul>
                    </div>
