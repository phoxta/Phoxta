...
const GALLERY_IMGS = [
    { src: "/assets/imgs/pages/img-130.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-131.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-132.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-133.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-134.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-135.webp", alt: "phoxta" },
    { src: "/assets/imgs/pages/img-136.webp", alt: "phoxta" },
];
