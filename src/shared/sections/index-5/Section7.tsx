...
const TESTIMONIALS: TestimonialItem[] = [
    {
        ...
        quote:
            '"Phoxta doesn\'t just build models; he builds engines for growth. His ability to deploy complex architectures with 99.9% reliability is what sets his work apart."',
        headerFirst: true,
        orderClass: "order-1",
    },
    {
    ...
    },
    {
        ...
        quote:
            '"Phoxta possesses a rare architectural intuition. He successfully optimized our legacy neural networks, reducing latency by 40% without compromising on model accuracy."',
        headerFirst: true,
