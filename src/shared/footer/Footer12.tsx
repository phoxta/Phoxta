                ...
                <div className="container-fluid px-3 px-lg-5">
                    <div className="footer-12__cta-inner">
                        ...
                        <form className="footer-12__cta-form at_fade_anim" data-fade-from="bottom" data-delay=".25" action="#" method="post">
                            ...
                            <input id="footer12Email" className="footer-12__cta-input" type="email" name="email" placeholder="hello@phoxta.studio" required />
                ...
                <div className="container-fluid px-3 px-lg-5">
                    ...
                    <div className="footer-12__columns">
                        <div className="footer-12__col footer-12__col--brand">
                            <Link className="footer-12__brand" to="/index-12" aria-label="Phoxta home">
                                <img className="footer-12__brand-logo" src="/assets/imgs/template/logo/logo-w.svg" alt="Phoxta" loading="lazy" />
                            </Link>
