...
import Section6 from "@/shared/sections/index-8/Section6";
import Section7 from "@/shared/sections/index-8/Section7";
import Section8 from "@/shared/sections/index-8/Section8";
import Section9 from "@/shared/sections/index-8/Section9";
import Section10 from "@/shared/sections/index-8/Section10";

export default function Home8Page() {
  return (
    <>
      <PageMeta title="Phoxta - Home8" />
                <Section1 />
                <Section2 />
                <Section3 />
                <Section4 />
