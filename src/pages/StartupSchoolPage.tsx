...
// clears it for the first content section. Sections ordered as a funnel:
// intro → syllabus → how it works → who it's for → CTA → instructors →
// testimonials → marquee → insights → FAQ → enroll.
